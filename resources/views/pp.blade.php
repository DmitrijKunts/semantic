...
@section('content')
    <div class="text-gray-600 body-font">
        <div class="container px-5 py-12 mx-auto">
            <div class="flex flex-col text-justify w-full mb-20">
                ...
                <div class="lg:w-2/3 mx-auto leading-relaxed text-base">
                    ...
                    <p>{{ config('app.name') }} follows a standard procedure of using log files. These files log visitors
                        when
                        they visit
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                        are used in their respective advertisements and links that appear on {{ config('app.name') }},
                        which are
                        sent
                    ...
                    <p>Note that {{ config('app.name') }} has no access to or control over these cookies that are used by
                        third-party
                        advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>{{ config('app.name') }}'s Privacy Policy does not apply to other advertisers or websites. Thus, we
                        are
                        advising
